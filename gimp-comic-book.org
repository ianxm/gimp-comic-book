...
To install, basically you just copy [[https://raw.githubusercontent.com/ianxm/gimp-comic-book/main/scripts/comic-book.scm][the script]] to your local plugin
directory and restart GIMP. There are detailed instructions [[https://thegimptutorials.com/how-to-install-gimp-plugins/][here]].
...
menu. The options are described in the [[*register][register section]].
